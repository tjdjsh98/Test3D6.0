...
public class PrototypeCharacterController : NetworkBehaviour, IBeforeTick
{
    ...
    bool _isEnableInputRotate = true;
    public bool IsEnableInputRotate { get { return _isEnableInputRotate; } set
        {
            Debug.Log($"Input {value}");
            _isEnableInputRotate = value;
        }
} 
    public bool IsEnableJump { get; set; } = true;  
